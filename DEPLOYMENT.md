...
3. Precalienta cada modelo permitido desde una cuenta de mantenimiento antes de abrir tráfico. La primera petición descarga cientos de MB; `/models` es persistente.
