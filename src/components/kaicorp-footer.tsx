  ...
  return (
    <footer className="border-t border-white/5 px-4 py-5">
      <div className="mx-auto flex w-full max-w-5xl flex-col items-center gap-2 text-center sm:flex-row sm:justify-between sm:text-left">
        ...
        <a href="https://secret.kaicorplabs.com" className="text-muted hover:text-accent transition-colors">SecretDrop</a>
        <span className="text-muted opacity-60" aria-current="page">Pixelforge</span>
        </nav>
      </div>
    </footer>
  );
